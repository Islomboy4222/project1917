		...
		<div class="main-header">
			...
			<nav class="navbar navbar-header navbar-expand-lg">
				<div class="container-fluid">
					...
					<form class="navbar-left navbar-form nav-search mr-md-3" method="GET" action="{{route('admin.search')}}">
						<div class="input-group">
							<input type="text" name="search" required placeholder="Search ..." class="form-control">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu dropdown-user">
								<li>
									<div class="user-box">
										<div class="u-img"><img src="/admin/img/profile.jpg" alt="user"></div>
										<div class="u-text">
											<h4>Hizrian</h4>
...
<script src="/admin/bootstrap/js/core/bootstrap.min.js"></script>
